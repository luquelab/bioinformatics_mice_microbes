...
The simplest way to use pyCapsid is using this [colab notebook](https://github.com/luquelab/bioinformatics_mice_microbes/blob/main/notebooks/main_pipeline.ipynb)
